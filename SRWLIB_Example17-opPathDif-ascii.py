...
from srwlib import srwl_uti_save_intens_ascii
...
strOpPathOutFileName = 'ex17_res_opt_path_dif-ASCII.dat'
#output type ('srw', 'png', 'jpg','tiff')
return_type = 'srw' 
...
#Optical path difference data to an ASCII file:
    print("   Saving optical path difference data to an ASCII file: " + strOpPathOutFileName)
    srwl_uti_save_intens_ascii(opPathDif, opTMesh, os.path.join(os.getcwd(), strDataFolderName, strOpPathOutFileName))
